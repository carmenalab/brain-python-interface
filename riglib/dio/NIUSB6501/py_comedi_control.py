...
def write_to_comedi(data, mask = 255, method = 'use_swig', debug = False):
    '''
    ...
    if method == 'use_swig':
        return write_to_comedi_swig(data, mask = mask, debug = debug)
...
def write_to_comedi_swig(data, mask = 255, debug = False):
    '''
    ...
    '''
    retval = set_bits_in_nidaq_using_mask_and_data(mask, data)
