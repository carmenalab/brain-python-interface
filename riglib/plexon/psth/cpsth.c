/* Generated by Cython 0.16 on Wed Nov 14 14:44:49 2012 */
...
static int __pyx_pf_5cpsth_8SpikeBin___cinit__(struct __pyx_obj_5cpsth_SpikeBin *__pyx_v_self, PyArrayObject *__pyx_v_channels, double __pyx_v_binlen, PyObject *__pyx_v_funcname, PyObject *__pyx_v_params) {
  ...
  __pyx_pybuffernd_channels.rcbuffer = &__pyx_pybuffer_channels;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_channels.rcbuffer->pybuffer, (PyObject*)__pyx_v_channels, &__Pyx_TypeInfo_nn___pyx_t_5numpy_int32_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 8; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
 ...
 */
  ...
  __pyx_v_self->info = bin_init(((int *)__pyx_v_channels->data), __pyx_t_11, __pyx_v_binlen, __pyx_t_12, __pyx_v__params);
