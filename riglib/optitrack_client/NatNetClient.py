...
class NatNetClient:
    def __init__( self ):
        ...
        self.serverIPAddress = "10.155.206.1" 

        # Change this value to the IP address of your local network interface
        self.localIPAddress = '10.155.205.164'
    ...
    def __createDataSocket( self, port):
        ...
        #mreq=socket.inet_aton(self.multicastAddress)+socket.inet_aton(socket.INADDR_ANY)
        ...
        #result.bind( (self.localIPAddress, port) ) # bug, why would you bind to yourself if you wanna receive data from a remote server! 
    ...
    def __dataThreadFunction( self, socket ):
        while True:
            # Block for input
            data, addr = socket.recvfrom(1024) # 32k byte buffer size
            if( len( data ) > 0 ):
