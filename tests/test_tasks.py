...
class TestManualControlTasks(unittest.TestCase):
    ...
    def test_tracking(self):
        seq = TrackingTask.tracking_target_debug(nblocks=1, ntrials=10, time_length=5, seed=40, sample_rate=60) # sample_rate needs to match fps in ScreenTargetTracking
