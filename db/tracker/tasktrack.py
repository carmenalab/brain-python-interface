...
# class TaskWrapper2(RPCProcess2):
#     '''
#     Wrapper for Experiment classes launched from the web interface
#     '''
#     proxy = TaskObjProxy

#     def __init__(self, subj, params, task_class=experiment.Experiment, 
#         websock=None, status=None,
...
#         self.status = "running" if saveid is not None else "testing"        
