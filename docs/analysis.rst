...
------------------------
.. note :: You should do this ONLY on machines which are devoted to analysis. NEVER EVER have multiple databases on a machine which runs the actual experiments, you are just asking for trouble if you do!
